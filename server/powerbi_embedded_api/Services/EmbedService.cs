...
namespace powerbi_embedded_api.Services
{
    ...
    public class EmbedService : IEmbedService
    {
        ...
        public async Task<DashboardEmbedConfig> EmbedDashboard(Guid workspaceId, Guid dashboardId)
        {
            // Create a Power BI Client object. It will be used to call Power BI APIs.
            using (var client = await GetPowerBiClient())
            {
                // Get a list of dashboards.
                var dashboard = await client.Dashboards.GetDashboardAsync(dashboardId);
                ...
                var tokenResponse = await client.Dashboards.GenerateTokenInGroupAsync(workspaceId, dashboardId, generateTokenRequestParameters);
