...
export class ReportsComponent implements OnInit {
  private readonly workspaceId: string = "839940d7-ba79-4b1c-bf12-2f48e476acec"; // Servian //"db097125-a738-4629-9a9b-93e6367f921e";
  ...
  ngOnInit() {
    this.pbiService.getReports(this.workspaceId).subscribe((result => 
      this.reports = result), 
      error => console.log(error)
    );

    this.pbiService.getWorkspaces().subscribe(res => console.log("Workspaces", res));
  }
  getReportConfig(event: any) {
    ...
    this.http.get(this.baseUrl + `api/reports/GetReportConfig/${this.workspaceId}/${reportId}`).subscribe((result: any) => {
